...
class MeaningScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.meaning = "" # Initialize meaning as an empty string
        self.date = ""
    ...
    def setup_ui(self):
        self.display_current_meaning()
        print("Meaning that is now stored: \n", self.meaning)
        ...
        self.text_widget.insert(tk.END, self.meaning)
        ...
        self.back_button = self.create_icon_only_button(self, "Icons/home.png", "Icons/home_press.png", lambda: self.go_back())
    ...
    def display_current_meaning(self):
        ...
        if row:
            ...
            self.meaning = row[4]  # Assuming the Meaning is in the 5th column
        else:
            self.meaning = "Meaning not available"
        conn.close()
