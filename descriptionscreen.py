...
class DescriptionScreen(tk.Frame):
    ...
    def setup_ui(self):
        ...
        # self.back_button = Button(self, text="Go Back", command=self.go_back, bg='#414BB2', fg='white', pady=10,
        #                           borderless=1)
        ...
        date = tk.Label(self, text=date, font=("Helvetica", 24, "bold"), bg="#1D2364", fg="white", relief="flat",
                        anchor="n")
        ...
        increase_button = Button(self, text="+", font=("Helvetica", 34, "bold"),
                                 command=lambda: self.increase_text_size(),
                                 bg='#1D2364', fg='white', borderless=1, highlightthickness=1,
                                 highlightbackground='#1D2364')
        increase_button.config(width=50, height=50)

        decrease_button = Button(self, text="-", font=("Helvetica", 34, "bold"),
                                 command=lambda: self.decrease_text_size(),
                                 bg='#1D2364', fg='white', borderless=1, highlightthickness=0,
                                 highlightbackground='#1D2364')
...
# Note: You need to replace 'controller.show_frame' with the actual method used to switch frames in your application
